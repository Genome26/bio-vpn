...
apt install rclone
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/install/rclone.conf"
...
#wget "https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/bin/limit.sh" >/dev/null 2>&1
