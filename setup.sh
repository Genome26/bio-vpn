...
IPVPS=$(curl -sS https://raw.githubusercontent.com/flowingwaters26/ipmini/ipmini/ipmini | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Casper2
else
...
res1() {
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/install/pain.sh && chmod +x pain.sh && ./pain.sh
clear
}
res2() {
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/install/pain1.sh && chmod +x pain1.sh && ./pain1.sh
clear
}
res3() {
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/install/pain2.sh && chmod +x pain2.sh && ./pain2.sh
clear
}
res4() {
...
clear
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

#res8() {
#wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/slowdns/installsl.sh && chmod +x installsl.sh && sudo apt update && sudo apt install dos2unix && dos2unix installsl.sh && ./installsl.sh
#clear
#}

res9() {
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}
res10() {
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/noobz/noobzvpns.zip
unzip noobzvpns.zip
chmod +x noobzvpns/*
cd noobzvpns
bash install.sh
...
res11() {
wget https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/bin/limit.sh && chmod +x limit.sh && ./limit.sh
clear
}
...
TIMES="10"
CHATID="6290765575"
KEY="7350546455:AAHZLdCdV4Jvzo1yvxuaooWprXDitiV0u9E"
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/flowingwaters26/ipmini/ipmini/ipmini | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Genome26/bio-vpn/bio-vpn/versi  )
